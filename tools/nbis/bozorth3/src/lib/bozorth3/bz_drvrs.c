...
if ( msim < MAX_PAIR_TABLE_SIZE  )	/* Makes sure there are a reasonable number of edges (at least 500, if possible) to analyze in the Web */
...
#define MAX_PAIR_TABLE_SIZE 32
if ( mfim < MAX_PAIR_TABLE_SIZE  )	/* Makes sure there are a reasonable number of edges (at least 500, if possible) to analyze in the Web */
